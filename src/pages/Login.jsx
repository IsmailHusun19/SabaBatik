...
const Login = () => {
  ...
  return (
    <>
      <div className="flex h-screen min-h-[600px] flex-1 flex-col justify-center px-2 py-12 lg:px-8 bg-gray-200">
        <div className="relative isolate px-6 pt-14 lg:px-8 flex flex-col items-center justify-center">
          <div
